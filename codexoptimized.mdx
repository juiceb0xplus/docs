...
|-- \_[MANIFEST.md](http://MANIFEST.md)                           [SACRED] Project consciousness - the 1000-word truth
...
|   |-- [overview.md](http://overview.md)                       # Executive summary: what this app is in 2 paragraphs

|   |-- vision_and\_[mission.md](http://mission.md)             # The long-term destination and why we're building this

|   |-- business\_[model.md](http://model.md)                 # Revenue strategy, pricing, market analysis

|   |-- user_personas/                    # Who we're building for

|   |   |-- primary\_[user.md](http://user.md)               # "Sarah, the startup founder who needs..."

|   |   \`-- secondary\_[users.md](http://users.md)            # Additional user types and their needs

|   |-- features/                         # Feature definitions from product perspective

|   |   |-- \_feature\_[map.md](http://map.md)               # Master list with priority and status

|   |   |-- core/                         # MVP/essential features

|   |   |   \`-- user\_[authentication.md](http://authentication.md)    # Business rules, user flows, success metrics

|   |   \`-- growth/                       # Phase 2\+ features

|   |       \`-- team\_[collaboration.md](http://collaboration.md)     # Future feature specs

|   |-- competitive\_[analysis.md](http://analysis.md)           # Market position, differentiators, competitor teardowns

|   |-- success\_[metrics.md](http://metrics.md)                # KPIs, OKRs, and how we measure winning

|   \`-- [roadmap.md](http://roadmap.md)                        # Timeline from MVP to v2.0 with key milestones

|

|-- 02_DESIGN/                             [EXPERIENTIAL] How users interact with the application

|   |-- information\_[architecture.md](http://architecture.md)       # Sitemap, navigation structure, content hierarchy

|   |-- user_journeys/                    # End-to-end user flows

|   |   |-- onboarding\_[flow.md](http://flow.md)            # From landing page to activated user

|   |   \`-- core\_[workflow.md](http://workflow.md)              # Primary value-delivery path

|   |-- interface\_[patterns.md](http://patterns.md)             # Reusable UI patterns and components

|   |-- wireframes/                       # Low-fi structural designs

|   |   \`-- dashboard\_[layout.md](http://layout.md)           # ASCII diagrams or linked design files

|   \`-- design\_[system.md](http://system.md)                  # Colors, typography, spacing, voice & tone

|

|-- 03_ARCHITECTURE/                       [TECHNICAL] System design and implementation strategy

|   |-- system\_[design.md](http://design.md)                  # High-level: monolith vs microservices, sync vs async

|   |-- technical\_[stack.md](http://stack.md)                # Detailed stack decisions with versions

|   |-- data_model/                       # Schema and data relationships

|   |   |-- entity\_[diagram.md](http://diagram.md)             # Conceptual model of all entities

|   |   |-- database_schema.sql           # Actual SQL or Prisma schema

|   |   \`-- api\_[contracts.md](http://contracts.md)              # REST/GraphQL endpoint specifications

|   |-- infrastructure/                   # Deployment and operations

|   |   |-- aws\_[architecture.md](http://architecture.md)           # VPC, ECS, RDS, CloudFront setup

|   |   |-- ci_cd\_[pipeline.md](http://pipeline.md)             # GitHub Actions workflow definitions

|   |   \`-- monitoring\_[plan.md](http://plan.md)            # DataDog, Sentry, CloudWatch setup

|   |-- security\_[model.md](http://model.md)                 # Auth, authz, encryption, compliance

|   |-- performance\_[budget.md](http://budget.md)             # Load targets, latency requirements

|   \`-- third_party\_[services.md](http://services.md)           # Stripe, SendGrid, Twilio integrations

|

|-- 04_SPECIFICATIONS/                     [DETAILED] Implementation-ready specifications

|   |-- \_spec\_[template.md](http://template.md)                 # Standard template for all specifications

|   |-- api_endpoints/                    # Detailed endpoint specifications

|   |   |-- auth/

|   |   |   |-- POST\_[login.spec.md](http://login.spec.md)        # Request/response, validation, errors

|   |   |   \`-- POST\_[register.spec.md](http://register.spec.md)     # Full implementation details

|   |   \`-- resources/

|   |       \`-- GET_users\_[id.spec.md](http://id.spec.md)      # Resource endpoint specs

|   |-- components/                       # Frontend component specifications

|   |   |-- [AuthForm.spec.md](http://AuthForm.spec.md)              # Props, state, behavior, edge cases

|   |   \`-- [DataTable.spec.md](http://DataTable.spec.md)             # Reusable component specifications

|   |-- workflows/                        # Complex multi-step processes

|   |   \`-- payment\_[processing.spec.md](http://processing.spec.md)    # Stripe integration flow

|   \`-- algorithms/                       # Core business logic specifications

|       \`-- recommendation\_[engine.spec.md](http://engine.spec.md) # Detailed algorithm design

|

|-- 05_DECISIONS/                          [RATIONAL] The "why" behind every choice

|   |-- \_decision\_[template.md](http://template.md)             # ADR-inspired template

|   |-- active/                           # Current decisions we're operating under

|   |   |-- [2024-08-05-001-use-nextjs.md](http://2024-08-05-001-use-nextjs.md)  # "Chose Next.js over Remix because..."

|   |   |-- [2024-08-06-002-postgres-over-mongo.md](http://2024-08-06-002-postgres-over-mongo.md) # Database selection rationale

|   |   \`-- [2024-08-07-003-jwt-authentication.md](http://2024-08-07-003-jwt-authentication.md)  # Auth strategy decision

|   |-- superseded/                       # Decisions we've changed our mind about

|   |   \`-- [2024-07-01-001-use-firebase.md](http://2024-07-01-001-use-firebase.md) # "Originally chose Firebase, but..."

|   \`-- research/                         # Evidence supporting decisions

|       |-- auth_provider\_[comparison.md](http://comparison.md)   # Auth0 vs Supabase vs Clerk analysis

|       \`-- database\_[benchmarks.md](http://benchmarks.md)        # Performance testing results
...
|   |   |-- code\_[style.md](http://style.md)                 # Prettier config, naming conventions

|   |   |-- git\_[workflow.md](http://workflow.md)               # Branching strategy, commit format

|   |   \`-- testing\_[strategy.md](http://strategy.md)           # Unit, integration, E2E approach

|   |-- setup_guides/                     # How to get started

|   |   |-- local\_[development.md](http://development.md)          # Step-by-step local env setup

|   |   \`-- deployment\_[guide.md](http://guide.md)           # How to deploy to production

|   |-- troubleshooting/                  # Common issues and solutions

|   |   \`-- common\_[errors.md](http://errors.md)              # Known issues with fixes

|   \`-- module_docs/                      # Code-specific documentation

|       |-- auth\_[module.md](http://module.md)                # How the auth system works

|       \`-- payment\_[module.md](http://module.md)             # Payment processing implementation
...
|   |   |-- incident\_[response.md](http://response.md)          # What to do when things break

|   |   |-- backup\_[restore.md](http://restore.md)             # Disaster recovery procedures

|   |   \`-- scaling\_[playbook.md](http://playbook.md)           # How to handle traffic spikes

|   |-- maintenance/                      # Recurring tasks

|   |   |-- dependency\_[updates.md](http://updates.md)         # npm update strategy

|   |   \`-- database\_[maintenance.md](http://maintenance.md)       # Cleanup, optimization tasks

|   \`-- post_mortems/                     # Learning from failures

|       \`-- [2024-08-15-auth-outage.md](http://2024-08-15-auth-outage.md)     # What happened, why, how we fixed it
...
\`-- 08_DIALOGUE/                           [ACTIVE] Ongoing conversations and thinking
    ...
    |   |-- HIGH_should_we_use\_[kubernetes.md](http://kubernetes.md) # "Considering k8s, but..."

    |   |-- MED_payment_provider\_[choice.md](http://choice.md)   # "Stripe vs Paddle..."

    |   \`-- LOW_color_scheme\_[direction.md](http://direction.md)    # "Dark mode first or..."

    |-- hypotheses/                       # Ideas being explored

    |   \`-- ai_powered\_[recommendations.md](http://recommendations.md) # "What if we added..."

    |-- spikes/                           # Technical investigations

    |   \`-- websocket_scaling\_[test.md](http://test.md)     # "Tested [Socket.io](http://Socket.io) with 10k connections..."

    |-- meeting_notes/                    # Stakeholder/advisor conversations

    |   \`-- [2024-08-10-advisor-feedback.md](http://2024-08-10-advisor-feedback.md) # Key insights from discussions
...
[2-3 sentences from 01_PRODUCT/vision_and\_[mission.md](http://mission.md)]
...
1. [Current sprint focus - from 01_PRODUCT/[roadmap.md](http://roadmap.md)]
...
- [Product Overview](01_PRODUCT/[overview.md](http://overview.md))

- [Feature Map](01_PRODUCT/features/\_feature\_[map.md](http://map.md))

- [Design System](02_DESIGN/design\_[system.md](http://system.md))

- [Architecture Overview](03_ARCHITECTURE/system\_[design.md](http://design.md))
...
- Wireframe: [02_DESIGN/wireframes/[feature-name.md](http://feature-name.md)]

- User Flow: [02_DESIGN/user_journeys/[feature-name.md](http://feature-name.md)]

## Technical Approach

- Implementation Spec: [04_SPECIFICATIONS/[feature-name.spec.md](http://feature-name.spec.md)]
...
- Link to: [08_DIALOGUE/open_questions/[feature-related.md](http://feature-related.md)]

## Decision History

- [05_DECISIONS/active/[feature-related-decision.md](http://feature-related-decision.md)]
...
- Related Feature: [01_PRODUCT/features/[feature-name.md](http://feature-name.md)]

- User Journey: [02_DESIGN/user_journeys/[journey-name.md](http://journey-name.md)]
...
- **Architecture Decision:** [05_DECISIONS/active/[relevant-decision.md](http://relevant-decision.md)]

- **Research:** [05_DECISIONS/research/[relevant-research.md](http://relevant-research.md)]
...
- Research: [05_DECISIONS/research/[supporting-research.md](http://supporting-research.md)]
...
- Impacts Feature: [01_PRODUCT/features/[affected-feature.md](http://affected-feature.md)]

- Requires Architecture Change: [03_ARCHITECTURE/[affected-component.md](http://affected-component.md)]

- Updates Specification: [04_SPECIFICATIONS/[affected-spec.md](http://affected-spec.md)]
...

{
  ...
  "feature_context": {
    ...
    "include_layers": [
      ...
      "01_PRODUCT/features/core/user\_[authentication.md](http://authentication.md)",

      "02_DESIGN/user_journeys/onboarding\_[flow.md](http://flow.md)",

      "03_ARCHITECTURE/security\_[model.md](http://model.md)",
...
echo "Issue: [description]" \>\> \_pipeline/rollback\_[notes.md](http://notes.md)
...
- Updated \_[MANIFEST.md](http://MANIFEST.md)
